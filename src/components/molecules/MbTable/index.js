...
import EnhancedTableColumnSet from 'components/molecules/MbTable/EnhancedTableColumnSet';
...
import { tableHeaders, setHeader } from 'lib/api/common';
    ...
    withTheme(
      class EnhancedTableContainer extends React.Component {
        ...
        componentWillMount() {
          ...
          fetchHeader(tableHeaders, addColumnList).then(headers =>
            this.setState({
              ...this.state,
              headCells: headers,
            })
        ...
        componentDidUpdate(prevProps, prevState) {
          ...
          const { order: curOrder, orderBy: curOrderBy } = this.state;
          const { params } = prevProps;
          const { params: curParams } = this.props;
          if (
            !firstFetching &&
            (order !== curOrder ||
              orderBy !== curOrderBy ||
        ...
        fetchList = () => {
          ...
          const { order, orderBy, list } = this.state;
          dataReqPromise({
            params: {
              ...params,
              page,
        ...
        render() {
          ...
          const isLoading =
            this.state.list === null && this.state.error !== true;
            ...
            <>
              ...
              >
                <EnhancedTableWrap
                  ...
                  columnSetButton={
                    <DivisionWrap>
                      <EnhancedTableColumnSet
                        headCells={headCells}
                        handleSaveColumnSet={handleSaveColumnSet}
                      />
