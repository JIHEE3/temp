...
import { appTargetingAdverStatisticsData } from 'lib/api/datacenter';
...
let initParam = {};
const AppTargetingAdverStatistics = () => {
      ...
      {getInitParam && (
        <>
          <TableContainer
            ...
            dataReqPromise={appTargetingAdverStatisticsData}
            params={{ ...params }}
            order="desc"
            orderBy="ADVRTS_AMT"
            dense={true}
...
export default AppTargetingAdverStatistics;
