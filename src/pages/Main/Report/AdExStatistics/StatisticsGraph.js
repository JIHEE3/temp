...
import { adexTotDayGraph } from 'lib/api/adex';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faInfoCircle } from '@fortawesome/pro-light-svg-icons';

import { getFormat, getDate, twoDigits, makeGraph } from 'lib/commonLib';
...
const graphList = [
  ...
  {
    title: 'CTR',
    data: { bar: ['EXL_ITL_CLICK_RATE'] },
    yAxisData: {
      left: { EXL_ITL_CLICK_RATE: true, isPercent: true },
      right: {},
    },
    customizeData: {
      EXL_ITL_CLICK_RATE: {
  ...
  {
    title: 'ECPM',
    data: { bar: ['EXL_ITL_ECPM'] },
    yAxisData: {
      left: { EXL_ITL_ECPM: true },
      right: {},
    },
  },
];
...
class StatisticsGraph extends React.Component {
  ...
  getData = () => {
    ...
    const sDate = moment().subtract(3, 'month');
    const eDate = moment();
