...
import { openrtbGraph } from 'lib/api/openrtb';
...
const graphList = [
  ...
  },
  {
    ...
    yAxisData: {
      left: { SESSION_ROAS: true, isPercent: true },
      right: {},
    },
    customizeData: {
      SESSION_ROAS: {
  ...
  {
    title: i18next.t('입찰요청수'),
    data: { bar: ['BID_REQ_CNT'] },
    yAxisData: {
      left: { BID_REQ_CNT: true },
      right: {},
    },
  },
  {
  ...
  {
    title: i18next.t('낙찰수'),
    data: { bar: ['WIN_BID_CNT'] },
    yAxisData: {
      left: { WIN_BID_CNT: true },
      right: {},
    },
  },
  {
    title: i18next.t('낙찰평균CPM'),
    data: { bar: ['WIN_BID_ECPM'] },
    yAxisData: {
      left: { WIN_BID_ECPM: true, isPercent: true },
      right: {},
    },
    customizeData: {
      WIN_BID_ECPM: {
