...
import { localReport } from 'lib/api/localreport';
...
import LocalStatisticsGraph from "./LocalStatisticsGraph";
...
let initParam = {};
const LocalStatistics = ({ displayFilterList }) => {
    ...
    return (
        <>
            ...
            {getInitParam && (
                <>
                    <LocalStatisticsGraph params={{ ...params }} />
                    <TableContainer
                        className={classes.root}
                        dataReqPromise={localReport}
                        params={{ ...params }}
                        order="desc"
                        orderBy="ADVRTS_AMT"
                        dense={true}
